...
public class NewBank {
  ...
  private void addTestData() {
    ...
    bhagy.addAccount(new Account("Main", 10000.0));
    bhagy.addAccount(new Account("Savings", 20000.0));
    users.put("Bhagy", bhagy);

    Customer christina = new Customer("555", "Christina", "Keating");
    christina.addAccount(new Account("Savings", 150000.0));
    users.put("Christina", christina);

    Customer john = new Customer("101", "John", "Benardis");
    john.addAccount(new Account("Checking", 25000.0));
    users.put("John", john);
